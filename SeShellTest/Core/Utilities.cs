...
namespace SeShell.Test.Core
{
    public class Utilities
    {
        ...
        //public static TwitterLoginData GetBrowserBasedLoginCredentials(IWebDriver driver)
        //{
        //    var loginTestData = TwitterLoginData.GetLoginTestCases(); 
        ...
        public static void WaitTillDisplayed(IWebDriver webDriver, HtmlElementBy by, string elementIdentifier)
        {
            WaitTillDisplayed(webDriver, by, elementIdentifier, Configuration.WebDriverWaitTimeOut);
        }

        public static void WaitTillEnabled(IWebDriver webDriver, HtmlElementBy by, string elementIdentifier)
        {
            WaitTillEnabled(webDriver, by, elementIdentifier, Configuration.WebDriverWaitTimeOut);
        }

        public static void WaitTillDisplayed(IWebDriver webDriver, HtmlElementBy by, string elementIdentifier, int timeInSeconds)
        {
            ...
            {
                case HtmlElementBy.Id:
                    wait.Until(d => d.FindElement(By.Id(elementIdentifier)).Displayed);
                    break;
                case HtmlElementBy.Name:
                    wait.Until(d => d.FindElement(By.Name(elementIdentifier)).Displayed);
                    break;
                case HtmlElementBy.XPath:
                    wait.Until(d => d.FindElement(By.XPath(elementIdentifier)).Displayed);
                    break;
                case HtmlElementBy.ClassName:
                    wait.Until(d => d.FindElement(By.ClassName(elementIdentifier)).Displayed);
                    break;
                case HtmlElementBy.CssSelector:
                    wait.Until(d => d.FindElement(By.CssSelector(elementIdentifier)).Displayed);
                    break;
                case HtmlElementBy.LinkText:
                    wait.Until(d => d.FindElement(By.LinkText(elementIdentifier)).Displayed);
                    break;
                default:
        ...
        public static void WaitTillEnabled(IWebDriver webDriver, HtmlElementBy by, string elementIdentifier, int timeInSeconds)
        {
            WebDriverWait wait = new WebDriverWait(webDriver, TimeSpan.FromSeconds(timeInSeconds));
        ...
        public static void WaitTillSelected(IWebDriver webDriver, HtmlElementBy by, string elementIdentifier, int timeInSeconds)
        {
            WebDriverWait wait = new WebDriverWait(webDriver, TimeSpan.FromSeconds(timeInSeconds));
            ...
            {
                case HtmlElementBy.Id:
                    wait.Until(d => d.FindElement(By.Id(elementIdentifier)).Selected);
                    break;
                case HtmlElementBy.Name:
                    wait.Until(d => d.FindElement(By.Name(elementIdentifier)).Selected);
                    break;
                case HtmlElementBy.XPath:
                    wait.Until(d => d.FindElement(By.XPath(elementIdentifier)).Selected);
                    break;
                case HtmlElementBy.ClassName:
                    wait.Until(d => d.FindElement(By.ClassName(elementIdentifier)).Selected);
                    break;
                case HtmlElementBy.CssSelector:
                    wait.Until(d => d.FindElement(By.CssSelector(elementIdentifier)).Selected);
                    break;
                default:
                    throw new NotImplementedException();
            }
